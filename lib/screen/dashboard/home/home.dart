                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                innerContainerComponent(
                                    ...
                                    onTap: (){
                                      withdrawalBottomSheet(context,"0.11");
                                    },
                                    title: withdrawal),
                                innerContainerComponent(
                                    img: MyImages.thisProject,
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: LinearProgressIndicator(
                                      ...
                                      color: MyAppTheme.brownColor,
                                      semanticsValue: '${homeModel!.dashboard![0].isTotalEarned}',
                                      minHeight: 15,
                                      borderRadius: BorderRadius.circular(12),
                                      value: homeModel!.dashboard![0].totremain
                                  ),
                                ),
                          ...
                          Row(
                            children: [
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Mining Income", value: "\$ ${homeModel!.dashboard![0].roi}")),
                              const SizedBox(width: 10,),
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Boosting Income", value: "\$ ${homeModel!.dashboard![0].isbooster}"))
                            ],
                          ),
                          Row(
                            children: [
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Direct Income", value: "\$ ${homeModel!.dashboard![0].directincome}")),
                              const SizedBox(width: 10,),
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Level Income", value: "\$ ${homeModel!.dashboard![0].levelincome}"))
                            ],
                          ),
                          Row(
                            children: [
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Compounding Income", value: "\$ ${homeModel!.dashboard![0].rewardincome}")),
                              const SizedBox(width: 10,),
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Compounding Direct Income", value: "\$ ${homeModel!.dashboard![0].royaltyincome}"))
                            ],
                          ),
                          Row(
                            children: [
                              Expanded(child: CommonContainer(height: height* 0.10, title: "Compounding Level Income", value: "\$ ${homeModel!.dashboard![0].royaltyincome}"))
                            ],
                          ),
                          black16Text(wallet),
                          Row(
